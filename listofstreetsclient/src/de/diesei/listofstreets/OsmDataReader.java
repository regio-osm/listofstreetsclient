...
public class OsmDataReader {
	...
	private static final Logger logger = EvaluationNew.logger;
	...
	public StreetCollection ReadDataFromDB(EvaluationNew evaluation) {
		...
		String akt_jobname = evaluation.getJobname();
		...
		logger.log(Level.FINE, "   Job  =" + akt_jobname +"=  osm relation-id: "+rs_jobs.getString("osm_relation_id")+"   muni-id: "+rs_jobs.getString("id"));
		logger.log(Level.FINE, "----------------------------------------------------------------------------------------");
